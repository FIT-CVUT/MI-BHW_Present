...
/**
 *  @file 	example_ASM.h
 *	@brief 	@a Naive implementation of the NO-NAME encryption algorithm in ASM
 *
 *	The purpoase of this implementation is to show same basics in interfacing the C
 *	programming files with ASM source files in AVR Studio 4.
 */

#ifndef EXAMPLE_ASM_H
#define EXAMPLE_ASM_H

#include "types.h"

/**
 *	@brief	Calls the @a naive NO-NAME encryption algorithm implemented in ASM
 *
 ...
 *
 */	
void encrypt_asm_16( unsigned char * input, unsigned char * output, unsigned char * key );

/**
 *	@brief	Calls the @a naive NO-NAME decryption algorithm implemented in ASM
 *
 ...
 *
 */
void decrypt_asm_16( unsigned char * input, unsigned char * output, unsigned char * key );
